...
No se observa que sea necesario hacer alguna transformación de variable.
...
Con un nivel de significación del 95% se estima que existe una correlación entre la variable Examination y Agricultura, esta correlación es negativa.
...
Existe correlación positiva entre Examination y Education.
...
Existe correlación negativa entre Education y Agriculture.
